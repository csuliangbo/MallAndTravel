...
public class HomeMallAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void top(RecyclerView.ViewHolder holder, int position) {
        ...
        h1.toTravel.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void list(RecyclerView.ViewHolder holder, int position) {
        ...
        h2.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new MallAndTravelEvent(MallAndTravelEvent.TYPE_GOODS, 1));
            }
        });
    ...
    public HomeMallAdapter(Context context, String[] titles, String[] topImg) {
        this.titles = titles;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_TOP.ordinal()) {
            return new TOPHolder(mLayoutInflater.inflate(R.layout.item_home_mall_top, parent, false));
    ...
    public static class TOPHolder extends RecyclerView.ViewHolder {
        ...
        public TOPHolder(View itemView) {
            ...
            toTravel= (TextView) itemView.findViewById(R.id.toTravel);
