...
public class BottomBarTab extends FrameLayout {
    ...
    private int mPrimaryColor = 0xff12635D;
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, mPrimaryColor));
            mText.setTextColor(ContextCompat.getColor(mContext, mPrimaryColor));
        } else {
